...
const sectionIcons = {
  strategy_priorities: Target,
  implementation_roadmap: TrendingUp,
  operations_workflows: BarChart3,
  knowledge_content: BookOpen,
  governance_risk: AlertTriangle,
  metrics_roi: LineChart,
  change_enablement: Users,
  opportunities_innovation: Lightbulb,
  general_notes: FileText
};
      ...
      <div className="canvas-header">
        <div className="header-left">
          ...
          <div className="canvas-title-section">
            ...
            <p className="canvas-subtitle">Your advisory insights at a glance</p>
          </div>
        </div>
