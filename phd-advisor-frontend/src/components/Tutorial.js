...
const STEPS = [
  {
    id: 'welcome',
    type: 'modal',
    title: 'Welcome to the White Label AI Advisory Demo!',
    body: "Let\u2019s take a quick tour of the key features. You\u2019ll ask a question, compare response modes, and see how to adapt the framework for your own organization.",
    buttonText: "Let\u2019s Go!",
  },
  {
    id: 'click-suggestion',
    ...
    body: 'Click any Getting Started question to send it to all active personas and see how each perspective differs.',
    position: 'top',
  },
  {
    id: 'domain-query',
    ...
    title: 'Try a Domain-Specific Prompt',
    body: "We\u2019ve pre-filled a sample white-label prompt. Edit it if you like, then press Enter or click Send.\n\nIn your own deployment, this can reflect construction planning, HR operations, nonprofit programs, or any internal use case.",
    position: 'top',
    extraGap: 60,
    prefill: 'Create a 90-day AI adoption roadmap for our organization with clear milestones and ownership.',
  },
  {
    id: 'panel-toggle',
    type: 'highlight',
  ...
  },
  {
    ...
    body: "Here\u2019s another query to try in Aggregate mode. Send it to compare one synthesized answer against multi-persona panel responses.",
    position: 'top',
    prefill: 'How should leadership measure ROI for AI initiatives over the next two quarters?',
  },
  {
  ...
  },
  {
    ...
    body: 'Upload PDFs, Word docs, or text files. Personas can reference your real content using RAG \u2014 ideal for policy manuals, SOPs, project plans, or strategy documents.',
    position: 'top',
    extraGap: 60,
  },
  {
  ...
  },
  {
    ...
    body: 'The Canvas organizes insights from your chats into a structured summary \u2014 priorities, implementation ideas, risks, and next steps. Click to take a look!',
    position: 'right',
  },
  {
    id: 'user-guide',
  ...
  },
  {
    ...
    body: "You now know the essentials. Here are some things to try:\n\n\u2022 Ask for an AI adoption roadmap\n\u2022 Compare panel vs aggregate responses\n\u2022 Upload a company document to test RAG context\n\u2022 Open Canvas to review structured takeaways\n\nThe tutorial is always available from the Settings menu. Enjoy!",
    buttonText: 'Done',
    isFinal: true,
  },
];
